(function (h) {
    ...
    function n(a, c) {
        ...
        null !== a && 0 < a.length ? w(a[0], c, function () {
            a.shift();
            n(a, c)
        }) : v(c)
    }
    ...
    function w(a, c, m) {
        ...
        null !== a && "undefined" !== typeof a && h.ajax({
            url: a, async: c.async, cache: c.cache,
            dataType: "text", success: function (e, b) {
    ...
    function x(a, c) {
        for (var m = "", e = a.split(/\n/), b = /(\{\d+})/g, d = /\{(\d+)}/g, k = /(\\u.{4})/ig, f = 0, n = e.length; f < n; f++) {
            ...
            if (0 < l.length && "#" != l.match("^#")) {
                var p = l.split("=");
                if (0 < p.length) {
                    for (var l = decodeURI(p[0]).trim(), g = 1 == p.length ? "" : p[1]; -1 != g.search(/\\$/);) g =
                        g.substring(0, g.length - 1), g += e[++f].trimRight();
                    ...
                    if ("vars" == c.mode || "both" == c.mode) if (g = g.replace(/"/g, '\\"'), z(l), b.test(g)) {
                        var u = !0, r = "", t = [];
                        g.split(b).forEach(function (a) {
                            !b.test(a) || 0 !== t.length && -1 != t.indexOf(a) || (u || (r += ","), r += a.replace(d, "v$1"), t.push(a), u = !1)
                        });
                        m += l + "=function(" + r + "){";
                        l = '"' +
                            g.replace(d, '"+v$1+"') + '"';
    ...
    h.i18n.properties = function (a) {
        ...
        a.totalFiles = 2 * c.length + (5 <=
        a.language.length ? c.length : 0);
    ...
    h.i18n.prop = function (a) {
        ...
        if (2 == c.length) if (h.isArray(c[1])) var f = c[1]; else if ("object" === typeof c[1]) {
            var e = c[1].namespace;
        ...
        if ("string" == typeof b) {
            for (d = 0; -1 != (d = b.indexOf("\\", d));) b = "t" == b.charAt(d + 1) ? b.substring(0, d) + "\t" + b.substring(d++ + 2) : "r" == b.charAt(d + 1) ? b.substring(0, d) + "\r" + b.substring(d++ + 2) : "n" == b.charAt(d + 1) ? b.substring(0, d) + "\n" + b.substring(d++ + 2) : "f" == b.charAt(d + 1) ? b.substring(0, d) + "\f" + b.substring(d++ + 2) : "\\" == b.charAt(d + 1) ? b.substring(0, d) + "\\" +
                b.substring(d++ + 2) : b.substring(0, d) + b.substring(d + 1);
            var k = [];
            for (d = 0; d < b.length;) if ("'" == b.charAt(d)) if (d == b.length - 1) b = b.substring(0, d); else if ("'" == b.charAt(d + 1)) b = b.substring(0, d) + b.substring(++d); else {
                for (e = d + 2; -1 != (e = b.indexOf("'", e));) if (e == b.length - 1 || "'" != b.charAt(e + 1)) {
                    b = b.substring(0, d) + b.substring(d + 1, e) + b.substring(e + 1);
                    d = e - 1;
                    break
                } else b = b.substring(0, e) + b.substring(++e);
                -1 == e && (b = b.substring(0, d) + b.substring(d + 1))
            } else if ("{" == b.charAt(d)) if (e = b.indexOf("}", d + 1), -1 == e) d++; else {
                var n =
                    parseInt(b.substring(d + 1, e));
                !isNaN(n) && 0 <= n ? (d = b.substring(0, d), "" !== d && k.push(d), k.push(n), d = 0, b = b.substring(e + 1)) : d = e + 1
            } else d++;
            "" !== b && k.push(b);
            b = k;
    ...
    h.i18n.normaliseLanguageCode = function (a) {
        var c = a.language;
        if (!c || 2 > c.length) a.debug && f("No language supplied. Pulling it from the browser ..."), c = navigator.languages && 0 < navigator.languages.length ? navigator.languages[0] : navigator.language || navigator.userLanguage || "en", a.debug && f("Language from browser: " + c);
        c = c.toLowerCase();
        c = c.replace(/-/, "_");
